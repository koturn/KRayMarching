Shader "koturn/KRayMarching/DomainOctrahedrons"
{
    Properties
    {
        // ---------------------------------------------------------------------
        ...
        [Space(8)]
        _GridSize ("Grid size", Range(0.001, 100.0)) = 1.0
        _OctahedronSize ("Size of Octahedrons", Float) = 0.5

        _AnimSpeed ("Animation speed", Range(0.0, 100.0)) = 0.5
        _SpinSpeedRange ("Spin speed", Range(0.0, 100.0)) = 4.0


        // ---------------------------------------------------------------------
        [Header(Lighting Parameters)]
        [Space(8)]
        _Color ("Base color", Color) = (0.8, 0.4, 0.4, 1.0)
    ...
    CustomEditor "Koturn.KRayMarching.Inspectors.DomainOctahedronsGUI"
}
