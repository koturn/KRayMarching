Shader "koturn/KRayMarching/Primitives/Link"
{
    Properties
    {
        // ---------------------------------------------------------------------
        ...
        [Space(8)]
        _Height ("Height of Link", Float) = 0.25

        _Size ("Size of Link", Float) = 0.2

        _Thickness ("Thickness of Link", Float) = 0.05
    ...
    //
    // TODO: Specify CustomEditor.
    //
    // CustomEditor "Koturn.KRayMarching.Inspectors.Primitives.LinkGUI"
}
