Shader "koturn/KRayMarching/Primitives/ArbitaryCappedCylinder"
{
    Properties
    {
        // ---------------------------------------------------------------------
    ...
    SubShader
    {
        ...
        float map(float3 p)
        {
            return sdCappedCylinder(p, _Position1, _Position2, _Radius);
        }
        ENDCG
    ...
    CustomEditor "Koturn.KRayMarching.Inspectors.Primitives.ArbitaryCapsuleCylinderGUI"
}
