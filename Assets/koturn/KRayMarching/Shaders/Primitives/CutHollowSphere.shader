Shader "koturn/KRayMarching/Primitives/CutHollowSphere"
{
    Properties
    {
        // ---------------------------------------------------------------------
        ...
        [Space(8)]
        _Radius ("Radius of Sphere", Float) = 0.5

        _Height ("Height of Half Sphere", Float) = 0.2

        _Thickness ("Thickness of Sphere", Float) = 0.01
    ...
    SubShader
    {
        ...
        float map(float3 p)
        {
            return sdCutHollowSphere(p, _Radius, _Height, _Thickness);
        }
        ENDCG
    ...
    CustomEditor "Koturn.KRayMarching.Inspectors.Primitives.SphereGUI"
}
