Shader "koturn/KRayMarching/Primitives/Octahedron"
{
    Properties
    {
        // ---------------------------------------------------------------------
    ...
    SubShader
    {
        ...
        UNITY_DEFINE_INSTANCED_PROP(float3, _OctahedronScales)
        ...
        float map(float3 p)
        {
            ...
            return sdOctahedronExact(
                p,
                UNITY_ACCESS_INSTANCED_PROP(Props, _Size),
                UNITY_ACCESS_INSTANCED_PROP(Props, _OctahedronScales));
        #else
            return sdOctahedron(
                p,
                UNITY_ACCESS_INSTANCED_PROP(Props, _Size),
    ...
    CustomEditor "Koturn.KRayMarching.Inspectors.Primitives.OctahedronGUI"
}
