Shader "koturn/KRayMarching/Primitives/BoxFrame"
{
    Properties
    {
        // ---------------------------------------------------------------------
        ...
        _OverRelaxFactor ("Coefficient of Over Relaxation Sphere Tracing", Range(1.0, 2.0)) = 1.6

        _AccelarationFactor ("Coefficient of Accelarating Sphere Tracing", Range(0.0, 1.0)) = 0.5

        _AutoRelaxFactor ("Coefficient of Automatic Step Size Relaxation", Range(0.0, 1.0)) = 0.5
        ...
        [Space(8)]
        [Vector3]
        _Size ("Size of the Box", Vector) = (0.25, 0.25, 0.25, 0.20)

        _FrameSize ("Size of the frame of the box", Float) = 0.025
    ...
    SubShader
    {
        ...
        //! Size of the frame of the box.
        UNITY_DEFINE_INSTANCED_PROP(float, _FrameSize)
        ...
        float map(float3 p)
        {
            return sdBoxFrame(
                ...
                UNITY_ACCESS_INSTANCED_PROP(Props, _FrameSize));
        }
        ENDCG
    ...
    CustomEditor "Koturn.KRayMarching.Inspectors.Primitives.BoxGUI"
}
