Shader "koturn/KRayMarching/Primitives/Pyramid"
{
    Properties
    {
        // ---------------------------------------------------------------------
        ...
        _StepMethod ("Marching step method", Int) = 3
        ...
        _AutoRelaxFactor ("Coefficient of Automatic Step Size Relaxation", Range(0.0, 1.0)) = 0.9
        ...
        [Space(8)]
        _Height ("Height of the Pyramid", Float) = 0.5
    ...
    SubShader
    {
        ...
        float map(float3 p)
        {
            return sdPyramid(p, UNITY_ACCESS_INSTANCED_PROP(Props, _Height));
        }
        ENDCG
    ...
    CustomEditor "Koturn.KRayMarching.Inspectors.Primitives.PyramidGUI"
}
