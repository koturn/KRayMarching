Shader "koturn/KRayMarching/Primitives/Plane"
{
    Properties
    {
        // ---------------------------------------------------------------------
        ...
        _OverRelaxFactor ("Coefficient of Over Relaxation Sphere Tracing", Range(1.0, 2.0)) = 1.1
    ...
    CustomEditor "Koturn.KRayMarching.Inspectors.Primitives.PlaneGUI"
}
