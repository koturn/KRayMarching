Shader "koturn/KRayMarching/Primitives/Rhombus"
{
    Properties
    {
        // ---------------------------------------------------------------------
        ...
        [Space(8)]
        [Vector2]
        _Size ("Size in XZ-axis direction", Vector) = (0.1, 0.4, 0.0, 0.0)

        _Height ("Height of Rhombus", Float) = 0.05

        _Round ("Round of Rhombus", Float) = 0.025
    ...
    SubShader
    {
        ...
        float map(float3 p)
        {
            return sdRhombus(p, _Size, _Height, _Round);
        }
        ENDCG
    ...
    CustomEditor "Koturn.KRayMarching.Inspectors.Primitives.RhombusGUI"
}
