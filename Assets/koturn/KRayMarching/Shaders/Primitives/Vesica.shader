Shader "koturn/KRayMarching/Primitives/Vesica"
{
    Properties
    {
        // ---------------------------------------------------------------------
        ...
        _Width ("Width of Vesica", Float) = 0.2
    ...
    CustomEditor "Koturn.KRayMarching.Inspectors.Primitives.VesicaGUI"
}
