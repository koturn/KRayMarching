Shader "koturn/KRayMarching/Primitives/RoundedCylinder"
{
    Properties
    {
        // ---------------------------------------------------------------------
        ...
        [Space(8)]
        _Height ("Height of Cylinder", Float) = 0.3

        _Radius ("Radius of Cylinder", Float) = 0.1

        _Round ("Round of Cylinder", Float) = 0.1
