Shader "koturn/KRayMarching/Primitives/CappedTorus"
{
    Properties
    {
        // ---------------------------------------------------------------------
        ...
        _AccelarationFactor ("Coefficient of Accelarating Sphere Tracing", Range(0.0, 1.0)) = 0.45
        ...
        [Space(8)]
        _Radius ("Radius of the Torus", Float) = 0.4

        _Thickness ("Thickness of the Torus", Float) = 0.1

        _Angle ("Angle of the Torus (in degrees)", Range(0.0, 360.0)) = 90
    ...
    CustomEditor "Koturn.KRayMarching.Inspectors.Primitives.TorusGUI"
}
