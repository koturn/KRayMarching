Shader "koturn/KRayMarching/Primitives/RoundBox"
{
    Properties
    {
        // ---------------------------------------------------------------------
        ...
        _AutoRelaxFactor ("Coefficient of Automatic Step Size Relaxation", Range(0.0, 1.0)) = 0.75
        ...
        [Space(8)]
        [Vector3]
        _Size ("Size of the Box", Vector) = (0.25, 0.25, 0.25, 0.0)

        _Round ("Round of the Box", Float) = 0.05
