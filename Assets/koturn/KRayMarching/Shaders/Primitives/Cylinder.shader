Shader "koturn/KRayMarching/Primitives/Cylinder"
{
    Properties
    {
        // ---------------------------------------------------------------------
        ...
        [Space(8)]
        [Vector2]
        _Center ("Center of Cylinder", Vector) = (0.0, 0.0, 0.0, 0.0)
    ...
    CustomEditor "Koturn.KRayMarching.Inspectors.Primitives.CylinderGUI"
}
