Shader "koturn/KRayMarching/Primitive/TriPrism"
{
    Properties
    {
        ...
        _Size ("Size of the Triangular", Float) = 0.5
        _Height ("Height of the Prism", Float) = 0.5
    ...
    SubShader
    {
        ...
        #pragma shader_feature_local_fragment _ _NOT_EXACT_ON

        #include "PrimitiveTemplate.cginc"

        //! Size of the Triangular.
        uniform float _Size;
        //! Height of the Prism.
        ...
        float map(float3 p)
        {
            return sdTriPrism(p, _Size, _Height);
        }
        ENDCG
    ...
    CustomEditor "Koturn.KRayMarching.Primitive.PrismGUI"
}
